...
{
    [Table("SORDERQ", Schema = "TESTPROD")]
    [Index(nameof(Sohnum0), nameof(Soplin0), nameof(Soqseq0), Name = "SORDERQ_SOQ0", IsUnique = true)]
    [Index(nameof(Stofcy0), nameof(Shidat0), nameof(Bpcord0), nameof(Bpaadd0), nameof(Itmref0), Name = "SORDERQ_SOQ1")]
    [Index(nameof(Itmref0), nameof(Shidat0), Name = "SORDERQ_SOQ2")]
    [Index(nameof(Soqsta0), nameof(Shidat0), nameof(Dlvpiocmp0), nameof(Sohnum0), nameof(Soplin0), nameof(Soqseq0), Name = "SORDERQ_SOQ3", IsUnique = true)]
    [Index(nameof(Soqsta0), nameof(Sohcat0), nameof(Stofcy0), nameof(Bpcord0), nameof(Bpaadd0), Name = "SORDERQ_SOQ4")]
    public partial class Sorderq
    {
        [Required]
        [Column("SOHNUM_0")]
        [StringLength(20)]
        ...
        [Column("DEMDLVREF_0")]
        [StringLength(20)]
        public string Demdlvref0 { get; set; }
        [Column("IMPNUMLIG_0")]
        ...
        [Column("YEDILINENO_0")]
        public short Yedilineno0 { get; set; }
        [Key]
        [Column("ROWID")]
