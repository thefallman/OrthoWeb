...
{
    [Table("MFCMAT", Schema = "TESTPROD")]
    [Index(nameof(Stofcy0), nameof(Itmref0), nameof(Vcrtyp0), nameof(Vcrnum0), nameof(Vcrlin0), nameof(Mfctyp0), nameof(Matref0), nameof(Uid0), Name = "MFCMAT_MCC0", IsUnique = true)]
    public partial class Mfcmat
    {
        [Required]
        [Column("STOFCY_0")]
        [StringLength(5)]
