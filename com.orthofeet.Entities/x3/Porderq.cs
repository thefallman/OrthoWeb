...
{
    [Table("PORDERQ", Schema = "TESTPROD")]
    [Index(nameof(Pohnum0), nameof(Poplin0), nameof(Poqseq0), Name = "PORDERQ_POQ0", IsUnique = true)]
    [Index(nameof(Lininvflg0), nameof(Wipsta0), nameof(Bpsinv0), nameof(Itmref0), nameof(Pohnum0), Name = "PORDERQ_POQ1")]
    [Index(nameof(Lincleflg0), nameof(Wipsta0), nameof(Prhfcy0), nameof(Bpsnum0), nameof(Pohnum0), Name = "PORDERQ_POQ2")]
    [Index(nameof(Pohnum0), nameof(Poqlnk0), Name = "PORDERQ_POQ3", IsUnique = true)]
    [Index(nameof(Vcrtypori0), nameof(Vcrnumori0), nameof(Vcrlinori0), nameof(Vcrseqori0), nameof(Itmrefori0), Name = "PORDERQ_POQ4")]
    public partial class Porderq
    {
        ...
        [Column("XGRPNUM_0")]
        [StringLength(1)]
        public string Xgrpnum0 { get; set; }
