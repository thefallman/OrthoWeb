...
{
    [Table("EFASIML", Schema = "TESTPROD")]
    [Index(nameof(Ref0), nameof(Timstp0), Name = "EFASIML_EVE0", IsUnique = true)]
    [Index(nameof(Ref0), nameof(Timstpo0), nameof(Timstp0), Name = "EFASIML_EVE1", IsUnique = true)]
    [Index(nameof(Cptflg0), nameof(Dprpln0), nameof(Cpy0), nameof(Fcy0), nameof(Ref0), Name = "EFASIML_EVE2")]
    public partial class Efasiml
    {
        [Required]
        [Column("CPY_0")]
        [StringLength(5)]
        ...
        [Column("RVARVE_0", TypeName = "numeric(27, 13)")]
        public decimal Rvarve0 { get; set; }
