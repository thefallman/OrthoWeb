...
{
    [Table("CONTREW", Schema = "TESTPROD")]
    [Index(nameof(Connum0), Name = "CONTREW_CRE0")]
    [Index(nameof(Connum0), nameof(Rewrecnumx0), Name = "CONTREW_CRE1", IsUnique = true)]
    public partial class Contrew
    {
        [Required]
        [Column("CONNUM_0")]
        [StringLength(20)]
