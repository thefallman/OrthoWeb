...
{
    [Table("EXPENSES", Schema = "TESTPROD")]
    [Index(nameof(Clb0), nameof(Datexs0), nameof(Nbrexs0), Name = "EXPENSES_EXS0", IsUnique = true)]
    [Index(nameof(Accnum0), Name = "EXPENSES_EXS1", IsUnique = true)]
    [Index(nameof(Cpy0), nameof(Cur0), nameof(Fcy0), nameof(Datexs0), Name = "EXPENSES_EXS2")]
    [Index(nameof(Vcrtyp0), nameof(Vcrnum0), nameof(Accnum0), Name = "EXPENSES_EXS3", IsUnique = true)]
