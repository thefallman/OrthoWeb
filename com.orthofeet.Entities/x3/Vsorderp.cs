...
{
    [Table("VSORDERP", Schema = "TESTPROD")]
    [Index(nameof(Sohnum0), nameof(Linrevnum0), nameof(Soplin0), nameof(Sopseq0), Name = "VSORDERP_VOP0", IsUnique = true)]
    public partial class Vsorderp
    {
        [Required]
        [Column("SOHNUM_0")]
        [StringLength(20)]
