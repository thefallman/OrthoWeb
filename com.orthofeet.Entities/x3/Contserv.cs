...
{
    [Table("CONTSERV", Schema = "TESTPROD")]
    [Index(nameof(Connum0), Name = "CONTSERV_CON0", IsUnique = true)]
    [Index(nameof(Conenddat0), Name = "CONTSERV_CON1")]
    [Index(nameof(Conbpc0), Name = "CONTSERV_CON2")]
    [Index(nameof(Conccn0), Name = "CONTSERV_CON3")]
    [Index(nameof(Conbpc0), nameof(Rsiflg0), nameof(Fddflg0), Name = "CONTSERV_CON4")]
    [Index(nameof(Conori0), nameof(Conorivcr0), nameof(Conorivcrl0), Name = "CONTSERV_CON5")]
    public partial class Contserv
    {
        [Required]
        [Column("CONNUM_0")]
        [StringLength(20)]
        ...
        [Column("MANREWFRY_0")]
        public short Manrewfry0 { get; set; }
        [Column("MANREWFRYBAS_0")]
        public byte Manrewfrybas0 { get; set; }
        [Column("MANCONREW_0")]
        public byte Manconrew0 { get; set; }
        [Column("MANCONSTRDAT_0", TypeName = "datetime")]
        public DateTime Manconstrdat0 { get; set; }
        [Column("MANCONENDDAT_0", TypeName = "datetime")]
        public DateTime Manconenddat0 { get; set; }
        [Column("RSILTI_0")]
