...
{
    [Table("PORDER", Schema = "TESTPROD")]
    [Index(nameof(Pohnum0), Name = "PORDER_POH0", IsUnique = true)]
    [Index(nameof(Bpsnum0), nameof(Orddat0), nameof(Pohnum0), Name = "PORDER_POH1", IsUnique = true)]
    [Index(nameof(Orddat0), nameof(Pohnum0), Name = "PORDER_POH2", IsUnique = true)]
    public partial class Porder
    {
        ...
        [Column("XA_RPTTYP5_0")]
        public short XaRpttyp50 { get; set; }
        [Required]
        [Column("DSPVOU_0")]
        [StringLength(3)]
        ...
        [Column("XA_OUTTYP5_0")]
        public short XaOuttyp50 { get; set; }
        ...
        [Required]
        [Column("XA_CONTACT5_0")]
        [StringLength(1)]
        public string XaContact50 { get; set; }
        [Required]
        [Column("INVDTAVAT1_0")]
        [StringLength(5)]
        ...
        [Column("XCNTSIZ_0")]
        [StringLength(1)]
        public string Xcntsiz0 { get; set; }
        [Required]
        [Column("UPDUSR_0")]
        [StringLength(5)]
        ...
        [Column("XCNTFLG_0")]
        public short Xcntflg0 { get; set; }
        [Required]
        [Column("XBROKER_0")]
        [StringLength(1)]
        public string Xbroker0 { get; set; }
        [Column("XB_850STA_0")]
        public byte Xb850sta0 { get; set; }
        [Key]
        [Column("ROWID")]
