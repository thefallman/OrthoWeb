...
{
    [Table("EFASISS", Schema = "TESTPROD")]
    [Index(nameof(Ref0), nameof(Timstp0), Name = "EFASISS_EVE0", IsUnique = true)]
    [Index(nameof(Ref0), nameof(Timstpo0), nameof(Timstp0), Name = "EFASISS_EVE1", IsUnique = true)]
    [Index(nameof(Cptflg0), nameof(Dprpln0), nameof(Cpy0), nameof(Fcy0), nameof(Ref0), Name = "EFASISS_EVE2")]
    public partial class Efasiss
    {
        [Required]
        [Column("CPY_0")]
        [StringLength(5)]
        ...
        [Column("ISSRATCUR_0", TypeName = "numeric(8, 3)")]
        public decimal Issratcur0 { get; set; }
        ...
        [Column("CPLDEDVAT_0", TypeName = "numeric(27, 13)")]
        public decimal Cpldedvat0 { get; set; }
        [Column("REVVAT_0", TypeName = "numeric(27, 13)")]
        public decimal Revvat0 { get; set; }
        ...
        [Column("SORREG_0", TypeName = "datetime")]
        public DateTime Sorreg0 { get; set; }
        [Column("SORREGT_0", TypeName = "datetime")]
        public DateTime Sorregt0 { get; set; }
        [Column("SORREGI_0", TypeName = "datetime")]
        public DateTime Sorregi0 { get; set; }
        [Column("ADDDPR_0", TypeName = "numeric(27, 13)")]
        public decimal Adddpr0 { get; set; }
        [Key]
        [Column("ROWID")]
