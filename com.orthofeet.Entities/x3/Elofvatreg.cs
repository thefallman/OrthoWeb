...
{
    [Table("ELOFVATREG", Schema = "TESTPROD")]
    [Index(nameof(Ref0), nameof(Timstp0), Name = "ELOFVATREG_EVE0", IsUnique = true)]
    [Index(nameof(Ref0), nameof(Timstpo0), nameof(Timstp0), Name = "ELOFVATREG_EVE1", IsUnique = true)]
    [Index(nameof(Cptflg0), nameof(Dprpln0), nameof(Cpy0), nameof(Fcy0), nameof(Ref0), Name = "ELOFVATREG_EVE2")]
    public partial class Elofvatreg
    {
        [Required]
        [Column("CPY_0")]
        [StringLength(5)]
