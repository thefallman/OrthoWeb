...
{
    [Table("XATMATISS", Schema = "TESTPROD")]
    [Index(nameof(Stofcy0), nameof(Vcrnum0), nameof(Vcrlin0), nameof(Vcrseq0), nameof(Itmref0), nameof(Loc0), nameof(Lot0), nameof(Slo0), Name = "XATMATISS_XA50", IsUnique = true)]
    [Index(nameof(Stofcy0), nameof(Issuests0), Name = "XATMATISS_XA51")]
    public partial class Xatmatiss
    {
        [Required]
        [Column("STOFCY_0")]
        [StringLength(5)]
