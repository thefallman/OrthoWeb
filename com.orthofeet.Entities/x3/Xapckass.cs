...
{
    [Table("XAPCKASS", Schema = "TESTPROD")]
    [Index(nameof(Batch0), nameof(Batchseq0), Name = "XAPCKASS_XA30", IsUnique = true)]
    [Index(nameof(Stofcy0), nameof(Vcrnum0), nameof(Vcrlin0), nameof(Vcrseq0), nameof(Loc0), nameof(Lot0), nameof(Slo0), nameof(Sta0), nameof(Itmref0), Name = "XAPCKASS_XA31", IsUnique = true)]
    [Index(nameof(Stofcy0), nameof(Pcksts0), Name = "XAPCKASS_XA32")]
    public partial class Xapckass
    {
        [Required]
        [Column("STOFCY_0")]
        [StringLength(5)]
