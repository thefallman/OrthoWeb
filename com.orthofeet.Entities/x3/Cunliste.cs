...
{
    [Table("CUNLISTE", Schema = "TESTPROD")]
    [Index(nameof(Cunsssnum0), nameof(Cunlisnum0), Name = "CUNLISTE_CUL0", IsUnique = true)]
    [Index(nameof(Stofcy0), nameof(Cunsssnum0), nameof(Cunlisnum0), Name = "CUNLISTE_CUL1", IsUnique = true)]
    public partial class Cunliste
    {
        [Required]
        [Column("CUNSSSNUM_0")]
        [StringLength(20)]
        ...
        [Column("CUNLISDES_0")]
        [StringLength(30)]
        public string Cunlisdes0 { get; set; }
        [Column("CUNLISDAT_0", TypeName = "datetime")]
        public DateTime Cunlisdat0 { get; set; }
        [Required]
        [Column("STOFCY_0")]
        [StringLength(5)]
        ...
        [Column("CUNSTADAT_0", TypeName = "datetime")]
        public DateTime Cunstadat0 { get; set; }
        [Column("CUNLOKFLG_0")]
