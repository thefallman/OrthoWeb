...
{
    [Table("EFASACT", Schema = "TESTPROD")]
    [Index(nameof(Ref0), nameof(Timstp0), Name = "EFASACT_EVE0", IsUnique = true)]
    [Index(nameof(Ref0), nameof(Timstpo0), nameof(Timstp0), Name = "EFASACT_EVE1", IsUnique = true)]
    [Index(nameof(Cptflg0), nameof(Dprpln0), nameof(Cpy0), nameof(Fcy0), nameof(Ref0), Name = "EFASACT_EVE2")]
    public partial class Efasact
    {
        [Required]
        [Column("CPY_0")]
        [StringLength(5)]
        ...
        [Column("ETRNOTO_0", TypeName = "numeric(27, 13)")]
        public decimal Etrnoto0 { get; set; }
        [Column("ACTETR_0", TypeName = "numeric(27, 13)")]
        public decimal Actetr0 { get; set; }
        [Column("ETRNOTD_0", TypeName = "numeric(27, 13)")]
        public decimal Etrnotd0 { get; set; }
        [Column("IVCVATAMTO_0", TypeName = "numeric(27, 13)")]
        public decimal Ivcvatamto0 { get; set; }
        [Column("ACTIVC_0", TypeName = "numeric(27, 13)")]
        public decimal Activc0 { get; set; }
        [Column("IVCVATAMTD_0", TypeName = "numeric(27, 13)")]
        public decimal Ivcvatamtd0 { get; set; }
        [Column("DEDVATAMTO_0", TypeName = "numeric(27, 13)")]
        public decimal Dedvatamto0 { get; set; }
        [Column("ACTDED_0", TypeName = "numeric(27, 13)")]
        public decimal Actded0 { get; set; }
        [Column("DEDVATAMTD_0", TypeName = "numeric(27, 13)")]
        public decimal Dedvatamtd0 { get; set; }
        [Column("DPRBASO_0", TypeName = "numeric(27, 13)")]
        public decimal Dprbaso0 { get; set; }
        [Column("ACTDPR_0", TypeName = "numeric(27, 13)")]
        public decimal Actdpr0 { get; set; }
        [Column("DPRBASD_0", TypeName = "numeric(27, 13)")]
        public decimal Dprbasd0 { get; set; }
        [Column("TAXBASO_0", TypeName = "numeric(27, 13)")]
        public decimal Taxbaso0 { get; set; }
        [Column("ACTTAX_0", TypeName = "numeric(27, 13)")]
        public decimal Acttax0 { get; set; }
        [Column("TAXBASD_0", TypeName = "numeric(27, 13)")]
        public decimal Taxbasd0 { get; set; }
        [Column("GALREFBASO_0", TypeName = "numeric(27, 13)")]
        public decimal Galrefbaso0 { get; set; }
        [Column("ACTGAL_0", TypeName = "numeric(27, 13)")]
        public decimal Actgal0 { get; set; }
        [Column("GALREFBASD_0", TypeName = "numeric(27, 13)")]
        public decimal Galrefbasd0 { get; set; }
