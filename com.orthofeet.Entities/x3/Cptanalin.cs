...
{
    [Table("CPTANALIN", Schema = "TESTPROD")]
    [Index(nameof(Abrfic0), nameof(Vcrtyp0), nameof(Vcrnum0), nameof(Vcrlin0), nameof(Vcrseq0), nameof(Cplcle0), nameof(Analig0), Name = "CPTANALIN_CAL0", IsUnique = true)]
    public partial class Cptanalin
    {
        [Required]
        [Column("ABRFIC_0")]
        [StringLength(3)]
