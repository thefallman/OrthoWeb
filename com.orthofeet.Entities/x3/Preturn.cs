...
{
    [Table("PRETURN", Schema = "TESTPROD")]
    [Index(nameof(Pnhnum0), Name = "PRETURN_PNH0", IsUnique = true)]
    [Index(nameof(Bpsnum0), nameof(Rtndat0), Name = "PRETURN_PNH1")]
    [Index(nameof(Rtndat0), nameof(Pnhnum0), Name = "PRETURN_PNH2", IsUnique = true)]
    [Index(nameof(Cpy0), nameof(Rtndat0), Name = "PRETURN_PNH3")]
