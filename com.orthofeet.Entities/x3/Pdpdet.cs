...
{
    [Table("PDPDET", Schema = "TESTPROD")]
    [Index(nameof(Stofcy0), nameof(Itmref0), nameof(Buc0), nameof(Reqdat0), nameof(Wiptyp0), nameof(Wipnum0), Name = "PDPDET_CBD0", IsUnique = true)]
    [Index(nameof(Stofcy0), nameof(Sugtyp0), nameof(Sugsta0), nameof(Sugnum0), Name = "PDPDET_CBD1")]
    [Index(nameof(Stofcy0), nameof(Itmref0), nameof(Wiptyp0), nameof(Wipsta0), Name = "PDPDET_CBD2")]
    [Index(nameof(Itmref0), nameof(Stofcy0), nameof(Buc0), nameof(Reqdat0), nameof(Wiptyp0), nameof(Wipnum0), Name = "PDPDET_CBD3", IsUnique = true)]
    [Index(nameof(Itmrefori0), nameof(Stofcy0), nameof(Wiptyp0), nameof(Wipsta0), Name = "PDPDET_CBD4")]
    public partial class Pdpdet
    {
        [Required]
        [Column("STOFCY_0")]
        [StringLength(5)]
