...
{
    [Table("EFASLNKCNL", Schema = "TESTPROD")]
    [Index(nameof(Ref0), nameof(Timstp0), Name = "EFASLNKCNL_EVE0", IsUnique = true)]
    [Index(nameof(Ref0), nameof(Timstpo0), nameof(Timstp0), Name = "EFASLNKCNL_EVE1", IsUnique = true)]
    [Index(nameof(Cptflg0), nameof(Dprpln0), nameof(Cpy0), nameof(Fcy0), nameof(Ref0), Name = "EFASLNKCNL_EVE2")]
    public partial class Efaslnkcnl
    {
        [Required]
        [Column("CPY_0")]
        [StringLength(5)]
