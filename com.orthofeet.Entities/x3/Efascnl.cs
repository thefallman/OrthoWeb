...
{
    [Table("EFASCNL", Schema = "TESTPROD")]
    [Index(nameof(Ref0), nameof(Timstp0), Name = "EFASCNL_EVE0", IsUnique = true)]
    [Index(nameof(Ref0), nameof(Timstpo0), nameof(Timstp0), Name = "EFASCNL_EVE1", IsUnique = true)]
    [Index(nameof(Cptflg0), nameof(Dprpln0), nameof(Cpy0), nameof(Fcy0), nameof(Ref0), Name = "EFASCNL_EVE2")]
    public partial class Efascnl
    {
        [Required]
        [Column("CPY_0")]
        [StringLength(5)]
        ...
        [Column("CPTEXEANT_0")]
        public byte Cptexeant0 { get; set; }
