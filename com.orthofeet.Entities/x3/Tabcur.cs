...
{
    [Table("TABCUR", Schema = "TESTPROD")]
    [Index(nameof(Cur0), Name = "TABCUR_TCU0", IsUnique = true)]
    public partial class Tabcur
    {
        [Required]
        [Column("CUR_0")]
        [StringLength(3)]
        ...
        [Column("CURDES_0")]
        [StringLength(30)]
        public string Curdes0 { get; set; }
        [Column("CURRND_0", TypeName = "numeric(16, 6)")]
        public decimal Currnd0 { get; set; }
        [Required]
        [Column("CURSHO_0")]
        [StringLength(10)]
        public string Cursho0 { get; set; }
        [Required]
        [Column("CURFMT1_0")]
        [StringLength(10)]
        public string Curfmt10 { get; set; }
        [Required]
        [Column("CURFMT2_0")]
        [StringLength(10)]
        public string Curfmt20 { get; set; }
        [Required]
        [Column("CURFMT3_0")]
        [StringLength(10)]
        public string Curfmt30 { get; set; }
        [Column("EURFLG_0")]
        public byte Eurflg0 { get; set; }
        [Column("EURRAT_0", TypeName = "numeric(21, 10)")]
        public decimal Eurrat0 { get; set; }
        [Column("EURDAT_0", TypeName = "datetime")]
        public DateTime Eurdat0 { get; set; }
        [Column("CURENDDAT_0", TypeName = "datetime")]
        public DateTime Curenddat0 { get; set; }
        [Required]
        [Column("CURSYM_0")]
        [StringLength(10)]
        public string Cursym0 { get; set; }
        [Column("DECNBR_0")]
        public short Decnbr0 { get; set; }
        [Required]
        [Column("ISOCOD_0")]
        [StringLength(3)]
        public string Isocod0 { get; set; }
        [Required]
        [Column("CREUSR_0")]
        [StringLength(5)]
