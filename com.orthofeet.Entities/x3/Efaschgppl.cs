...
{
    [Table("EFASCHGPPL", Schema = "TESTPROD")]
    [Index(nameof(Ref0), nameof(Timstp0), Name = "EFASCHGPPL_EVE0", IsUnique = true)]
    [Index(nameof(Ref0), nameof(Timstpo0), nameof(Timstp0), Name = "EFASCHGPPL_EVE1", IsUnique = true)]
    [Index(nameof(Cptflg0), nameof(Dprpln0), nameof(Cpy0), nameof(Fcy0), nameof(Ref0), Name = "EFASCHGPPL_EVE2")]
    public partial class Efaschgppl
    {
        [Required]
        [Column("CPY_0")]
        [StringLength(5)]
        ...
        [Column("PROPLNO_0")]
        [StringLength(20)]
        public string Proplno0 { get; set; }
        [Required]
        [Column("PROPLNN_0")]
        [StringLength(20)]
        public string Proplnn0 { get; set; }
        [Key]
        [Column("ROWID")]
