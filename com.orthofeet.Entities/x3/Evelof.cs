...
{
    [Table("EVELOF", Schema = "TESTPROD")]
    [Index(nameof(Cpy0), nameof(Evt0), nameof(Pln0), nameof(Fcy0), nameof(Ref0), nameof(Lin0), nameof(Timstp0), nameof(Creusr0), Name = "EVELOF_EFS0", IsUnique = true)]
    [Index(nameof(Cpy0), nameof(Evt0), nameof(Pln0), nameof(Ref0), nameof(Lin0), nameof(Timstpo0), nameof(Creusro0), Name = "EVELOF_EFS1")]
    [Index(nameof(Cpy0), nameof(Evt0), nameof(Pln0), nameof(Ref0), nameof(Lin0), nameof(Cptflg0), nameof(Evtdat0), Name = "EVELOF_EFS2")]
    [Index(nameof(Cpy0), nameof(Evt0), Name = "EVELOF_EFS3")]
    public partial class Evelof
    {
        [Column("REFOBJ_0")]
