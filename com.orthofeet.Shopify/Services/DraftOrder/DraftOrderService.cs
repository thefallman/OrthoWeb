...
namespace com.orthofeet.Shopify.Services.DraftOrder 
{
    /// <summary>
    ...
    public class DraftOrderService : ShopifyService
    {
        ...
        /// </summary>
        public virtual async Task<ListResult<Entities.DraftOrder>> ListAsync(ListFilter<Entities.DraftOrder> filter = null, CancellationToken cancellationToken = default)
        {
        ...
        /// Gets a list of up to 250 of the shop's draft orders.
        /// </summary>
        public virtual async Task<ListResult<Entities.DraftOrder>> ListAsync(DraftOrderListFilter filter, CancellationToken cancellationToken = default)
        {
            return await ListAsync((ListFilter<Entities.DraftOrder>) filter, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.DraftOrder> GetAsync(long id, string fields = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.DraftOrder>($"draft_orders/{id}.json", "draft_order", fields, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.DraftOrder> CompleteAsync(long id, bool paymentPending = false, CancellationToken cancellationToken = default)
        {
            var req = PrepareRequest($"draft_orders/{id}/complete.json");
            req.QueryParams.Add("payment_pending", paymentPending);

            var response = await ExecuteRequestAsync<Entities.DraftOrder>(req, HttpMethod.Put, cancellationToken, rootElement: "draft_order");
            return response.Result;
        }
