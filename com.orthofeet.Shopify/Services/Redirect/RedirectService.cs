...
namespace com.orthofeet.Shopify.Services.Redirect
{
    /// <summary>
    ...
    public class RedirectService : ShopifyService
    {
        ...
        /// Gets a list of up to 250 of the shop's redirects.
        /// </summary>
        public virtual async Task<ListResult<Entities.Redirect>> ListAsync(RedirectListFilter filter = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Entities.Redirect> GetAsync(long redirectId, string fields = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Redirect>(req, HttpMethod.Get, cancellationToken, rootElement: "redirect");
        ...
        public virtual async Task<Entities.Redirect> CreateAsync(Entities.Redirect redirect, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Redirect>(req, HttpMethod.Post, cancellationToken, content, "redirect");
        ...
        public virtual async Task<Entities.Redirect> UpdateAsync(long redirectId, Entities.Redirect redirect, CancellationToken cancellationToken = default)
        {
            var req = PrepareRequest($"redirects/{redirectId}.json");
            var content = new JsonContent(new
            {
            ...
            var response = await ExecuteRequestAsync<Entities.Redirect>(req, HttpMethod.Put, cancellationToken, content, "redirect");
