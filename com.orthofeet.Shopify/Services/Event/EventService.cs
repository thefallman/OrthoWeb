...
namespace com.orthofeet.Shopify.Services.Event
{
    /// <summary>
    ...
    public class EventService : ShopifyService
    {
        ...
        public virtual async Task<Entities.Event> GetAsync(long eventId, string fields = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.Event>($"events/{eventId}.json", "event", fields, cancellationToken: cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.Event>> ListAsync(long subjectId, string subjectType, ListFilter<Entities.Event> filter = null, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        public virtual async Task<ListResult<Entities.Event>> ListAsync(ListFilter<Entities.Event> filter, CancellationToken cancellationToken = default)
        {
