...
namespace com.orthofeet.Shopify.Services.Asset
{
    /// <summary>
    ...
    public class AssetService : ShopifyService
    {
        ...
        /// <summary>
        /// Retrieves the <see cref="Entities.Asset"/> with the given id.
        /// </summary>
        ...
        /// <returns>The <see cref="Entities.Asset"/>.</returns>
        public virtual async Task<Entities.Asset> GetAsync(long themeId, string key, string fields = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Asset>(req, HttpMethod.Get, cancellationToken, rootElement: "asset");
            
            return response.Result;
        }

        /// <summary>
        /// Retrieves a list of all <see cref="Entities.Asset"/> objects. Listing theme assets only returns metadata about each asset.
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<IEnumerable<Entities.Asset>> ListAsync(long themeId, AssetListFilter filter = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<IEnumerable<Entities.Asset>>($"themes/{themeId}/assets.json", "assets", filter, cancellationToken);
        }
        ...
        /// <summary>
        /// Deletes a <see cref="Entities.Asset"/> with the given key.
        /// </summary>
        /// <param name="themeId">The id of the theme that the asset belongs to.</param>
        /// <param name="key">The key value of the asset, e.g. 'templates/index.liquid' or 'assets/bg-body.gif'.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
