...
using com.orthofeet.Shopify.Services.MetaField;

namespace com.orthofeet.Shopify.Services.Article
{
    /// <summary>
    ...
    public class ArticleService : ShopifyService
    {
        ...
        /// </summary>
        public virtual async Task<ListResult<Entities.Article>> ListAsync(long blogId, ListFilter<Entities.Article> filter = null, CancellationToken cancellationToken = default)
        {
        ...
        /// Gets a list of up to 250 articles belonging to the given blog.
        /// </summary>
        public virtual async Task<ListResult<Entities.Article>> ListAsync(int blogId, ArticleListFilter filter, CancellationToken cancellationToken = default)
        {
            return await ListAsync(blogId, (ListFilter<Entities.Article>) filter, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.Article> GetAsync(long blogId, long articleId, string fields = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Article>(req, HttpMethod.Get, cancellationToken, rootElement: "article");
        ...
        /// <param name="metafields">Optional metafield data that can be returned by the <see cref="MetaFieldService"/>.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.Article> UpdateAsync(long blogId, long articleId, Entities.Article article, IEnumerable<Entities.MetaField> metafields = null, CancellationToken cancellationToken = default)
        {
            var req = PrepareRequest($"blogs/{blogId}/articles/{articleId}.json");
            var body = article.ToDictionary();
            ...
            var response = await ExecuteRequestAsync<Entities.Article>(req, HttpMethod.Put, cancellationToken, content, "article");
            return response.Result;
        }
