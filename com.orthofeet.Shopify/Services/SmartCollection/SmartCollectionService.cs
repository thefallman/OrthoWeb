...
namespace com.orthofeet.Shopify.Services.SmartCollection
{
    /// <summary>
    ...
    public class SmartCollectionService : ShopifyService
    {
        ...
        /// </summary>
        public virtual async Task<ListResult<Entities.SmartCollection>> ListAsync(ListFilter<Entities.SmartCollection> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// Gets a list of up to 250 smart collections.
        /// </summary>
        public virtual async Task<ListResult<Entities.SmartCollection>> ListAsync(SmartCollectionListFilter filter = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.SmartCollection> GetAsync(long collectionId, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.SmartCollection>($"smart_collections/{collectionId}.json", "smart_collection", cancellationToken: cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.SmartCollection> PublishAsync(long smartCollectionId, CancellationToken cancellationToken = default)
        {
            var req = PrepareRequest($"smart_collections/{smartCollectionId}.json");
        ...
        /// <param name="smartCollectionId">The collection's id.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.SmartCollection> UnpublishAsync(long smartCollectionId, CancellationToken cancellationToken = default)
        {
            var req = PrepareRequest($"smart_collections/{smartCollectionId}.json");
            var body = new Dictionary<string, object>()
            {
