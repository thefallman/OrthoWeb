...
namespace com.orthofeet.Shopify.Services.Customer
{
    /// <summary>
    ...
    public class CustomerService : ShopifyService
    {
        ...
        /// </summary>
        public virtual async Task<ListResult<Entities.Customer>> ListAsync(ListFilter<Entities.Customer> filter = null, CancellationToken cancellationToken = default)
        {
        ...
        /// Gets a list of up to 250 of the shop's customers.
        /// </summary>
        public virtual async Task<ListResult<Entities.Customer>> ListAsync(CustomerListFilter filter, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Entities.Customer> GetAsync(long customerId, string fields = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.Customer>($"customers/{customerId}.json", "customer", fields, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.Customer>> SearchAsync(ListFilter<Entities.Customer> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="filter">Options for filtering the result.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.Customer>> SearchAsync(CustomerSearchListFilter filter, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Entities.Customer> CreateAsync(Entities.Customer customer, CustomerCreateOptions options = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Customer>(req, HttpMethod.Post, cancellationToken, content, "customer");
        ...
        public virtual async Task<Entities.Customer> UpdateAsync(long customerId, Entities.Customer customer, CustomerUpdateOptions options = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Customer>(req, HttpMethod.Put, cancellationToken, content, "customer");
            return response.Result;
        }
        ...
        /// </remarks>
        public virtual async Task<IEnumerable<Entities.Order>> ListOrdersForCustomerAsync(long customerId, CustomerOrderListFilter filter = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<List<Entities.Order>>($"customers/{customerId}/orders.json", "orders", filter, cancellationToken);
        }
    }
}
