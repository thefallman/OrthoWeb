...
namespace com.orthofeet.Shopify.Services.Blog
{
    /// <summary>
    ...
    public class BlogService : ShopifyService
    {
        ...
        /// </summary>
        public virtual async Task<ListResult<Entities.Blog>> ListAsync(ListFilter<Entities.Blog> filter = null, CancellationToken cancellationToken = default)
        {
        ...
        /// Gets a list of up to 250 blogs belonging to the store.
        /// </summary>
        public virtual async Task<ListResult<Entities.Blog>> ListAsync(BlogListFilter filter, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Entities.Blog> CreateAsync(Entities.Blog blog, IEnumerable<Entities.MetaField> metafields = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Blog>(request, HttpMethod.Post, cancellationToken, content, "blog");
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.Blog> GetAsync(long id, CancellationToken cancellationToken = default)
        {
            var request = PrepareRequest($"blogs/{id}.json");

            var response = await ExecuteRequestAsync<Entities.Blog>(request, HttpMethod.Get, cancellationToken, rootElement: "blog");
            return response.Result;
        }
