...
namespace com.orthofeet.Shopify.Services.ApplicationCredit
{
    /// <summary>
    ...
    public class ApplicationCreditService : ShopifyService
    {
        ...
        /// </summary>
        public virtual async Task<ListResult<Entities.ApplicationCredit>> ListAsync(ListFilter<Entities.ApplicationCredit> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// Gets a list of all past and present application credits.
        /// </summary>
        public virtual async Task<ListResult<Entities.ApplicationCredit>> ListAsync(ApplicationCreditListFilter filter, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Entities.ApplicationCredit> GetAsync(long id, string fields = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.ApplicationCredit>($"application_credits/{id}.json", "application_credit", fields, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.ApplicationCredit> CreateAsync(Entities.ApplicationCredit credit, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.ApplicationCredit>(req, HttpMethod.Post, cancellationToken, body, "application_credit");
