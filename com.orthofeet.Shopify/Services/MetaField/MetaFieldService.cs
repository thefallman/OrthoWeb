...
namespace com.orthofeet.Shopify.Services.MetaField
{
    /// <summary>
    ...
    public class MetaFieldService : ShopifyService
    {
        ...
        private async Task<ListResult<Entities.MetaField>> _ListAsync(string path, ListFilter<Entities.MetaField> filter,
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.MetaField>> ListAsync(ListFilter<Entities.MetaField> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="filter">Options to filter the results.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.MetaField>> ListAsync(long resourceId, string resourceType, ListFilter<Entities.MetaField> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="filter">Options to filter the results.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.MetaField>> ListAsync(long resourceId, string resourceType, long parentResourceId, string parentResourceType, ListFilter<Entities.MetaField> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="filter">Options to filter the results.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.MetaField>> ListAsync(MetaFieldFilter filter = null, CancellationToken cancellationToken = default)
        {
            return await _ListAsync("metafields.json", filter, cancellationToken);
        }
        ...
        /// <param name="filter">Options to filter the results.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.MetaField>> ListAsync(long resourceId, string resourceType, MetaFieldFilter filter = null, CancellationToken cancellationToken = default)
        {
            return await _ListAsync($"{resourceType}/{resourceId}/metafields.json", filter, cancellationToken);
        }
        ...
        /// <param name="filter">Options to filter the results.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.MetaField>> ListAsync(long resourceId, string resourceType, long parentResourceId, string parentResourceType, MetaFieldFilter filter = null, CancellationToken cancellationToken = default)
        {
            return await _ListAsync($"{parentResourceType}/{parentResourceId}/{resourceType}/{resourceId}/metafields.json", filter, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.MetaField> GetAsync(long metafieldId, string fields = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.MetaField>($"metafields/{metafieldId}.json", "metafield", fields, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.MetaField> CreateAsync(Entities.MetaField metafield, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.MetaField>(req, HttpMethod.Post, cancellationToken, content, "metafield");
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.MetaField> CreateAsync(Entities.MetaField metafield, long resourceId, string resourceType, long parentResourceId, string parentResourceType, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="resourceType">The resource type the metaifeld will be associated with. This can be variants, products, orders, customers, custom_collections, etc.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.MetaField> CreateAsync(Entities.MetaField metafield, long resourceId, string resourceType, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.MetaField> UpdateAsync(long metafieldId, Entities.MetaField metafield, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.MetaField>(req, HttpMethod.Put, cancellationToken, content, "metafield");
