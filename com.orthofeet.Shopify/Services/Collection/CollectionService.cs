...
namespace com.orthofeet.Shopify.Services.Collection
{
    /// <summary>
    ...
    public class CollectionService : ShopifyService
    {
        ...
        public async Task<ListResult<Entities.Product>> ListProductsAsync(long collectionId, ListFilter<Entities.Product> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="filter">Options for filtering the result.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public async Task<ListResult<Entities.Product>> ListProductsAsync(long collectionId, CollectionProductsListFilter filter = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.Collection> GetAsync(long collectionId, string fields = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.Collection>($"collections/{collectionId}.json", "collection", fields, cancellationToken);
        }
    }
}