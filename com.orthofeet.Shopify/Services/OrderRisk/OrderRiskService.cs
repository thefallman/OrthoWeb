...
namespace com.orthofeet.Shopify.Services.OrderRisk
{
    /// <summary>
    ...
    public class OrderRiskService : ShopifyService
    {
        ...
        public virtual async Task<ListResult<Entities.OrderRisk>> ListAsync(long orderId, ListFilter<Entities.OrderRisk> filter = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.OrderRisk> GetAsync(long orderId, long riskId, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.OrderRisk>($"orders/{orderId}/risks/{riskId}.json", "risk", cancellationToken: cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.OrderRisk> CreateAsync(long orderId, Entities.OrderRisk risk, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.OrderRisk>(req, HttpMethod.Post, cancellationToken, content, "risk");
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.OrderRisk> UpdateAsync(long orderId, long orderRiskId, Entities.OrderRisk risk, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.OrderRisk>(req, HttpMethod.Put, cancellationToken, content, "risk");
            return response.Result;
        }
