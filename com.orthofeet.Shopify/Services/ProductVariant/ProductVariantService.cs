...
namespace com.orthofeet.Shopify.Services.ProductVariant
{
    /// <summary>
    ...
    public class ProductVariantService : ShopifyService
    {
        ...
        public virtual async Task<ListResult<Entities.ProductVariant>> ListAsync(long productId, ListFilter<Entities.ProductVariant> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="productId">The product that the variants belong to.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.ProductVariant>> ListAsync(long productId, ProductVariantListFilter filter = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.ProductVariant> GetAsync(long variantId, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.ProductVariant>($"variants/{variantId}.json", "variant", cancellationToken: cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.ProductVariant> CreateAsync(long productId, Entities.ProductVariant variant, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.ProductVariant>(req, HttpMethod.Post, cancellationToken, content, "variant");
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.ProductVariant> UpdateAsync(long productVariantId, Entities.ProductVariant variant, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.ProductVariant>(req, HttpMethod.Put, cancellationToken, content, "variant");
