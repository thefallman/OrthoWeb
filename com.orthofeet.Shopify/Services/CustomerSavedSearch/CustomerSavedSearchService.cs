...
namespace com.orthofeet.Shopify.Services.CustomerSavedSearch
{
    /// <summary>
    ...
    public class CustomerSavedSearchService : ShopifyService
    {
        ...
        /// </summary>
        public virtual async Task<ListResult<Entities.CustomerSavedSearch>> ListAsync(ListFilter<Entities.CustomerSavedSearch> filter = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Entities.CustomerSavedSearch> GetAsync(long customerSearchId, string fields = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.CustomerSavedSearch>(req, HttpMethod.Get, cancellationToken, rootElement: RootElement);
        ...
        public virtual async Task<Entities.CustomerSavedSearch> CreateAsync(Entities.CustomerSavedSearch customerSavedSearch, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.CustomerSavedSearch>(req, HttpMethod.Post, cancellationToken, content, RootElement);
            return response.Result;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.CustomerSavedSearch> UpdateAsync(long customerSavedSearchId, Entities.CustomerSavedSearch customerSavedSearch, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.CustomerSavedSearch>(req, HttpMethod.Put, cancellationToken, content, RootElement);
            return response.Result;
        }
