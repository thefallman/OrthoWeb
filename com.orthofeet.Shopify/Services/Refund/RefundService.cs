...
namespace com.orthofeet.Shopify.Services.Refund
{
    /// <summary>
    ...
    public class RefundService : ShopifyService
    {
        ...
        public virtual async Task<ListResult<Entities.Refund>> ListForOrderAsync(long orderId, ListFilter<Entities.Refund> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="orderId">The id of the order to list orders for.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.Refund>> ListForOrderAsync(long orderId, RefundListFilter filter = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        /// <returns></returns>
        public virtual async Task<Entities.Refund> GetAsync(long orderId, long refundId, string fields = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.Refund>($"orders/{orderId}/refunds/{refundId}.json", "refund", fields, cancellationToken);
        }
        ...
        /// </summary>
        public virtual async Task<Entities.Refund> CalculateAsync(long orderId, Entities.Refund options, CancellationToken cancellationToken = default)
        {
            var req = PrepareRequest($"orders/{orderId}/refunds/calculate.json");
            var content = new JsonContent(new { refund = options });
            var response = await ExecuteRequestAsync<Entities.Refund>(req, HttpMethod.Post, cancellationToken, content, "refund");
        ...
        /// </summary>
        public virtual async Task<Entities.Refund> RefundAsync(long orderId, Entities.Refund options, CancellationToken cancellationToken = default)
        {
