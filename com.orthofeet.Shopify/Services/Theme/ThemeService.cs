...
namespace com.orthofeet.Shopify.Services.Theme
{
    /// <summary>
    ...
    public class ThemeService : ShopifyService
    {
        ...
        public virtual async Task<Entities.Theme> GetAsync(long themeId, string fields = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Theme>(req, HttpMethod.Get, cancellationToken, rootElement: "theme");
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.Theme> CreateAsync(Entities.Theme theme, CancellationToken cancellationToken = default)
        {
