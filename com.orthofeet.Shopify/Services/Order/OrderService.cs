...
namespace com.orthofeet.Shopify.Services.Order
{
    ...
    public class OrderService : ShopifyService
    {
        ...
        public virtual async Task<ListResult<Entities.Order>> ListAsync(ListFilter<Entities.Order> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        /// <returns>The list of orders matching the filter.</returns>
        public virtual async Task<ListResult<Entities.Order>> ListAsync(OrderListFilter filter = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Entities.Order> GetAsync(long orderId, string fields = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.Order>($"orders/{orderId}.json", "order", fields, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.Order> CloseAsync(long id, CancellationToken cancellationToken = default)
        {
            var req = PrepareRequest($"orders/{id}/close.json");
            var response = await ExecuteRequestAsync<Entities.Order>(req, HttpMethod.Post, cancellationToken, rootElement: "order");
        ...
        /// <param name="id">The order's id.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<Entities.Order> OpenAsync(long id, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Entities.Order> CreateAsync(Entities.Order order, OrderCreateOptions options = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Order>(req, HttpMethod.Post, cancellationToken, content, "order");
        ...
        public virtual async Task<Entities.Order> UpdateAsync(long orderId, Entities.Order order, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Order>(req, HttpMethod.Put, cancellationToken, content, "order");
        ...
        public virtual async Task<IEnumerable<Entities.MetaField>> GetMetaFieldsAsync(long orderId, CancellationToken cancellationToken = default)
        {
            var req = PrepareRequest($"orders/{orderId}/metafields.json");
            var response = await ExecuteRequestAsync<List<Entities.MetaField>>(req, HttpMethod.Get, cancellationToken, rootElement: "metafields");
