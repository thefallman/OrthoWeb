...
namespace com.orthofeet.Shopify.Services.UsageCharge
{
    /// <summary>
    ...
    public class UsageChargeService : ShopifyService
    {
        ...
        public virtual async Task<Entities.UsageCharge> CreateAsync(long recurringChargeId, string description, decimal price, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.UsageCharge>(req, HttpMethod.Post, cancellationToken, content, "usage_charge");
        ...
        public virtual async Task<Entities.UsageCharge> GetAsync(long recurringChargeId, long id, string fields = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.UsageCharge>(req, HttpMethod.Get, cancellationToken, rootElement: "usage_charge");
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<IEnumerable<Entities.UsageCharge>> ListAsync(long recurringChargeId, UsageChargeListFilter filter = null, CancellationToken cancellationToken = default)
        {
            var req = PrepareRequest($"recurring_application_charges/{recurringChargeId}/usage_charges.json");
            ...
            var response = await ExecuteRequestAsync<List<Entities.UsageCharge>>(req, HttpMethod.Get, cancellationToken, rootElement: "usage_charges");
