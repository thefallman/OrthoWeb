...
namespace com.orthofeet.Shopify.Services.Page
{
    ...
    public class PageService : ShopifyService
    {
        ...
        /// </summary>
        public virtual async Task<ListResult<Entities.Page>> ListAsync(ListFilter<Entities.Page> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// Gets a list of up to 250 of the shop's pages.
        /// </summary>
        public virtual async Task<ListResult<Entities.Page>> ListAsync(PageListFilter filter = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Entities.Page> GetAsync(long pageId, string fields = null, CancellationToken cancellationToken = default)
        {
            ...
            var response = await ExecuteRequestAsync<Entities.Page>(req, HttpMethod.Get, cancellationToken, rootElement: "page");
