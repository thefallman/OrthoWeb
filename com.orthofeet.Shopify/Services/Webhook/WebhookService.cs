...
namespace com.orthofeet.Shopify.Services.Webhook
{
    /// <summary>
    ...
    public class WebhookService : ShopifyService
    {
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.Webhook>> ListAsync(ListFilter<Entities.Webhook> filter, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="filter">Options for filtering the list.</param>
        /// <param name="cancellationToken">Cancellation Token</param>
        public virtual async Task<ListResult<Entities.Webhook>> ListAsync(WebhookListFilter filter = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Entities.Webhook> GetAsync(long webhookId, string fields = null, CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.Webhook>($"webhooks/{webhookId}.json", "webhook", fields, cancellationToken);
        }
