...
namespace com.orthofeet.Shopify.Services.Shop
{
    public class ShopService: ShopifyService
    {
        ...
        /// </summary>
        public virtual async Task<Entities.Shop> GetAsync(CancellationToken cancellationToken = default)
        {
            return await ExecuteGetAsync<Entities.Shop>("shop.json", "shop", cancellationToken: cancellationToken);
        }
